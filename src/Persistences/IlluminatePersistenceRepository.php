...
class IlluminatePersistenceRepository implements PersistenceRepositoryInterface
{
     ...
     *
     * @var \Acconplish\CustomSentinel\Sessions\SessionInterface
     */
    protected $session;
     ...
     *
     * @var \Acconplish\CustomSentinel\Cookies\CookieInterface
     */
    protected $cookie;
     ...
     * @var string
     */
    protected $model = 'Acconplish\CustomSentinel\Persistences\EloquentPersistence';

    /**
     * Create a new Sentinel persistence repository.
     *
     * @param  \Acconplish\CustomSentinel\Sessions\SessionInterface  $session
     * @param  \Acconplish\CustomSentinel\Cookies\CookieInterface  $cookie
     * @param  string  $model
     * @param  bool  $single
     * @return void
     */
