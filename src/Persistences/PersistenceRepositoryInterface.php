...
interface PersistenceRepositoryInterface
{
     ...
     *
     * @param  string  $code
     * @return \Acconplish\CustomSentinel\Persistences\PersistenceInterface|false
     */
     ...
     *
     * @param  string  $code
     * @return \Acconplish\CustomSentinel\Users\UserInterface|false
     */
     ...
     *
     * @param  \Acconplish\CustomSentinel\Persistences\PersistenceInterface  $persistable
     * @param  bool  $remember
     * @return bool
     */
     ...
     *
     * @param  \Acconplish\CustomSentinel\Persistences\PersistableInterface  $persistable
     * @return bool
     */
     ...
     *
     * @param  \Acconplish\CustomSentinel\Persistence\PersistableInterface  $persistable
     * @param  bool  $forget
     * @return void
     */
