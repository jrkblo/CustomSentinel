...
class IlluminateUserRepository implements UserRepositoryInterface
{
     ...
     * The hasher instance.
     *
     * @var \Acconplish\CustomSentinel\Hashing\HasherInterface
     */
    protected $hasher;
     ...
     * @var string
     */
    protected $model = 'Acconplish\CustomSentinel\Users\EloquentUser';

    /**
     * Create a new Illuminate user repository.
     *
     * @param  \Acconplish\CustomSentinel\Hashing\HasherInterface  $hasher
    ...
    public function create(array $credentials, Closure $callback = null)
    {
        ...
        $this->fireEvent('customsentinel.user.creating', compact('user', 'credentials'));
        ...
        $this->fireEvent('customsentinel.user.created', compact('user', 'credentials'));
    ...
    public function update($user, array $credentials)
    {
        ...
        $this->fireEvent('customsentinel.user.updating', compact('user', 'credentials'));

        $this->fill($user, $credentials);

        $user->save();

        $this->fireEvent('customsentinel.user.updated', compact('user', 'credentials'));
    ...
    {
        $this->fireEvent('customsentinel.user.filling', compact('user', 'credentials'));
        ...
        $this->fireEvent('customsentinel.user.filled', compact('user', 'credentials'));
    }

    /**
     * Returns the hasher instance.
     *
     * @return \Acconplish\CustomSentinel\Hashing\HasherInterface
     */
