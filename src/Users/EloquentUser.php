...
namespace Acconplish\CustomSentinel\Users;

use Acconplish\CustomSentinel\Permissions\PermissibleInterface;
use Acconplish\CustomSentinel\Permissions\PermissibleTrait;
use Acconplish\CustomSentinel\Persistences\PersistableInterface;
use Acconplish\CustomSentinel\Roles\RoleableInterface;
use Acconplish\CustomSentinel\Roles\RoleInterface;
...
class EloquentUser extends Model implements RoleableInterface, PermissibleInterface, PersistableInterface, UserInterface
{
     ...
     * @var string
     */
    protected static $rolesModel = 'Acconplish\CustomSentinel\Roles\EloquentRole';
     ...
     * @var string
     */
    protected static $persistencesModel = 'Acconplish\CustomSentinel\Persistences\EloquentPersistence';
     ...
     * @var string
     */
    protected static $activationsModel = 'Acconplish\CustomSentinel\Activations\EloquentActivation';
     ...
     * @var string
     */
    protected static $remindersModel = 'Acconplish\CustomSentinel\Reminders\EloquentReminder';
     ...
     * @var string
     */
    protected static $throttlingModel = 'Acconplish\CustomSentinel\Throttling\EloquentThrottle';
     ...
     *
     * @return \Acconplish\CustomSentinel\Permissions\PermissionsInterface
     */
